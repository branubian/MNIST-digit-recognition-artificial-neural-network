...
h1=int(input("enter number of neurons in first hidden layer: "))
h2=int(input("enter number of neurons in second hidden layer: "))
h3=int(input("enter number of neurons in third hidden layer: "))
...
def backprop_n_update_params(alpha):
  ...
  dC_dZ4 = (1 / m) * (A4 - y_labels_one_hot)
  ## print("dC_dZ4 shape is ", dC_dZ4.shape)
  ## print("n[4] is ", n[4])
  ## print("m is", m)
  assert dC_dZ4.shape == (n[4], m) ## last layer propagator
  ...
  dZ4_dA3 = W4
  dA3_dZ3 = A3 * (1 - A3)
  dC_dZ3 = (dZ4_dA3.T @ dC_dZ4) * dA3_dZ3
  assert dC_dZ3.shape == (n[3], m) ## third layer's propagator
  ...
  dZ3_dA2 = W3
  dA2_dZ2 = A2 * (1 - A2)
  dC_dZ2 = (dZ3_dA2.T @ dC_dZ3) * dA2_dZ2
